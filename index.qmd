...
This project aims to create infographics comparing attributes of soccer players, sourced from a European soccer database available on Kaggle. The database contains data on over 10,000 players. Using R exclusively, the visualization focuses on attributes such as shooting, finishing, strength, age, etc. All tasks, from fetching the data to adding text and aligning elements, are performed using R packages. Special credit is given to the UFO alien template, accessible at [UFO link](https://github.com/doehm/tidytues/blob/main/scripts/2023/week-25-ufo/ufo.png)

<p>Important Note:</p>

<p>The ggplot package version used in this project is 3.4.4, and ggtern version 3.0.0 is utilized. It's crucial to consider that modern versions of ggplot might conflict when used in combination with other packages employed here.</p>
