...
```{r, include=FALSE}
# #create word cloud based on player table and frequecy sets based on player weight
# library(wordcloud)
# library(tm)
# library(SnowballC)
# 
# # create a corpus from the player_name column
# corpus <- Corpus(VectorSource(Player$player_name))
#   
# # clean the corpus
...
# 
# #plot word cloud based on weight column
